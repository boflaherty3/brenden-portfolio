    ...
    return (
      <motion.div
        ...
        <div className="grid grid-cols-2 gap-4">
          {link && <a href={link} target="_blank" className="inline-block text-center border-2 border-blue-600 bg-transparent text-white px-4 py-2 rounded-full hover:bg-blue-600 transition-colors">View Project</a>}
